...
|:------------:|:------------------:|:-----------:|
| Little Wizard |04/12/2022 - present| UE developer |
| Pirate Clicker |01/09/2022 - 29/01/2023(Left the team)| A team project development in the Dverg Verksted studio for the Android platform on Unreal Engine 4. In the team as a UMG programmer. Link to [GitHub-Repo](https://github.com/Dverg-Verksted/PirateClicker). Link to [Itch io](https://dvergverksted.itch.io/pirate-clicker) |
| Gilo |01/06/2022 - 08/01/2023| A team project development in the Dverg Verksted studio on Unreal Engine 5. In the team as a UMG programmer. Link to [Repo GitHub](https://github.com/Dverg-Verksted/Gilo). Link to [Itch io](https://dvergverksted.itch.io/horror-game) |
...
| Arkanoid |05/08/2022 - 30/11/2022| A training project within the course on the Skillbox course. Link to [GitHub-Repo](https://github.com/Por7ableWorlD/Arkanoid). Link to [Itch io](https://por7ableworld.itch.io/arkanoid) |
